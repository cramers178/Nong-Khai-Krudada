    ...
    <div className="animate-fade-in glass-panel" style={{ padding: '3rem' }}>
      ...
      <div style={{ marginTop: '2rem', lineHeight: '1.8', fontSize: '1.1rem' }}>
        ...
        <p style={{ marginBottom: '2rem' }}>
          จังหวัดหนองคายเป็นจังหวัดที่มีเอกลักษณ์ด้านวัฒนธรรม ความเชื่อ และแหล่งท่องเที่ยวที่มีชื่อเสียง เช่น พญานาค วัดแก้วกู่ และผาตากเสื้อ ซึ่งเป็น Soft Power ที่สะท้อนอัตลักษณ์ของจังหวัดและสามารถส่งเสริมการท่องเที่ยว เศรษฐกิจ และการเรียนรู้ได้
        </p>
